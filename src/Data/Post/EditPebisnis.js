    ...
    return (
      <div class="card mb-3">
        <section
          ...
          style={{
            backgroundImage: `url("http://www.sportbusinesscentre.com/wp-content/uploads/2012/08/slider-062.jpg")`
          }}
        >
          <div class="container clearfix">
            ...
            <h5 class=" text-dark">
              <label style={{ backgroundColor: "greenyellow" }}>
                Isikan semua keterangan yang inging Anda ubah di bawah ini
              </label>
            </h5>
          </div>
        </section>
